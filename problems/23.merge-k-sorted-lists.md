...
这道题目是合并k个已排序的链表，号称leetcode目前`最难`的链表题。 和之前我们解决的[88.merge-sorted-array](88.merge-sorted-array.md)很像。 他们有两点区别：
...
![23.merge-k-sorted-lists](../.gitbook/assets/23.merge-k-sorted-lists.gif)

（动画来自 [https://zhuanlan.zhihu.com/p/61796021）](https://zhuanlan.zhihu.com/p/61796021）)
