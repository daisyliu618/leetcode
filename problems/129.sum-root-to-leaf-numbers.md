...
![129.sum-root-to-leaf-numbers-1](../.gitbook/assets/129.sum-root-to-leaf-numbers-1.jpg)

那么数字具体的计算逻辑，如图所示，相信大家通过这个不难发现规律：

![129.sum-root-to-leaf-numbers-2](../.gitbook/assets/129.sum-root-to-leaf-numbers-2.jpg)
