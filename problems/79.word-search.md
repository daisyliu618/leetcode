...
在起始位置不确定的情况下，扫描二维数组，找到字符跟给定单词的第一个字符相同的，四个方向（上，下，左，右）分别DFS搜索， 如果任意方向满足条件，则返回结果。不满足，回溯，重新搜索。
...
![word search 1](../.gitbook/assets/79.word-search-1.png)
...
单词匹配完成，满足条件，返回 `True`. ![word search 7](../.gitbook/assets/79.word-search-7.png)
